...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    drive.setDefaultCommand(
        Commands.run(
            () -> drive.driveArcade(-m_driverController.getLeftY(), m_driverController.getLeftX()),
            drive));
    m_operatorController.leftBumper().whileTrue(launcher.intakeCommand());
    m_operatorController.rightBumper().whileTrue(launcher.launchCommand());
  }
